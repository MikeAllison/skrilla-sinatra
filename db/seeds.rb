...
Bill.create(description: "Cell Phone", merchant_id: 5, frequency: 'monthly', starting_date: '2019-01-20', amount: 100.00, credit: false, account_id: 3)
Bill.create(description: "Rent", merchant_id: 6, frequency: 'monthly', starting_date: '2019-01-21', amount: 1100.00, credit: false, account_id: 1)
Bill.create(description: "BOA Credit Card Payment", merchant_id: 4, frequency: 'weekly', starting_date: '2019-01-22', amount: 50.00, credit: false, account_id: 1)
Bill.create(description: "Paycheck", merchant_id: 1, frequency: 'bi_weekly', starting_date: '2019-01-23', amount: 1000.00, credit: true, account_id: 1)
#=end
